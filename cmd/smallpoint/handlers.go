...
func (state *RuntimeState) allGroupsHandler(w http.ResponseWriter, r *http.Request) {
	...
	if state.Userinfo.UserisadminOrNot(username) == true {
		generateHTML(w, response, state.Config.Base.TemplatesURL, "index", "admins_sidebar", "groups")

	} else {
		generateHTML(w, response, state.Config.Base.TemplatesURL, "index", "sidebar", "groups")
	}
}
...
func (state *RuntimeState) mygroupsHandler(w http.ResponseWriter, r *http.Request) {
	...
	generateHTML(w, response, state.Config.Base.TemplatesURL, "index", sidebarType, "my_groups")
}
...
func (state *RuntimeState) pendingRequests(w http.ResponseWriter, r *http.Request) {
	...
	if groupnames == nil {
		generateHTML(w, response, state.Config.Base.TemplatesURL, "index", sidebarType, "no_pending_requests")

	} else {
		generateHTML(w, response, state.Config.Base.TemplatesURL, "index", sidebarType, "pending_requests")
...
func (state *RuntimeState) creategroupWebpageHandler(w http.ResponseWriter, r *http.Request) {
	...
	generateHTML(w, response, state.Config.Base.TemplatesURL, "index", "admins_sidebar", "create_group")
...
func (state *RuntimeState) deletegroupWebpageHandler(w http.ResponseWriter, r *http.Request) {
	...
	generateHTML(w, response, state.Config.Base.TemplatesURL, "index", "admins_sidebar", "delete_group")
...
func (state *RuntimeState) pendingActions(w http.ResponseWriter, r *http.Request) {
	...
	if response.PendingActions == nil {
		generateHTML(w, response, state.Config.Base.TemplatesURL, "index", sidebarType, "no_pending_actions")

	} else {
		generateHTML(w, response, state.Config.Base.TemplatesURL, "index", sidebarType, "pending_actions")
...
func (state *RuntimeState) createGrouphandler(w http.ResponseWriter, r *http.Request) {
	...
	generateHTML(w, Response{UserName: username}, state.Config.Base.TemplatesURL, "index", "admins_sidebar", "groupcreation_success")
}
...
func (state *RuntimeState) deleteGrouphandler(w http.ResponseWriter, r *http.Request) {
	...
	generateHTML(w, Response{UserName: username}, state.Config.Base.TemplatesURL, "index", "admins_sidebar", "groupdeletion_success")
...
func (state *RuntimeState) addmemberstoGroupWebpageHandler(w http.ResponseWriter, r *http.Request) {
	...
	generateHTML(w, response, state.Config.Base.TemplatesURL, "index", sidebarType, "addpeopletogroups")
...
func (state *RuntimeState) addmemberstoExistingGroup(w http.ResponseWriter, r *http.Request) {
	...
	generateHTML(w, Response{UserName: username}, state.Config.Base.TemplatesURL, "index", "admins_sidebar", "addpeopletogroup_success")
...
func (state *RuntimeState) deletemembersfromGroupWebpageHandler(w http.ResponseWriter, r *http.Request) {
	...
	generateHTML(w, response, state.Config.Base.TemplatesURL, "index", sidebarType, "deletemembersfromgroup")
...
func (state *RuntimeState) deletemembersfromExistingGroup(w http.ResponseWriter, r *http.Request) {
	...
	generateHTML(w, Response{UserName: username}, state.Config.Base.TemplatesURL, "index", "admins_sidebar", "deletemembersfromgroup_success")
...
func (state *RuntimeState) createserviceAccountPageHandler(w http.ResponseWriter, r *http.Request) {
	...
	generateHTML(w, response, state.Config.Base.TemplatesURL, "index", "admins_sidebar", "create_service_account")
...
func (state *RuntimeState) createServiceAccounthandler(w http.ResponseWriter, r *http.Request) {
	...
	generateHTML(w, Response{UserName: username}, state.Config.Base.TemplatesURL, "index", "admins_sidebar", "serviceacc_creation_success")
}
...
func (state *RuntimeState) groupInfoWebpage(w http.ResponseWriter, r *http.Request) {
	...
	if groupandmanagedby[0][1] != "self-managed" && !groupexistsornot {
		if !superAdmin {
			...
			generateHTML(w, response, state.Config.Base.TemplatesURL, "index", sidebarType, groupinfowebpageType)
			return
		}
